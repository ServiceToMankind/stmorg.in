  ...
  <body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-white">
        ...
        if(isset($_SESSION['USER_LOGIN']) && $_SESSION['USER_LOGIN']!=''){ ?>
            ...
            <div class="dropdown">
              ...
              <button
                class="btn btn-secondary dropdown-toggle btn-pro"
                type="button"
    ...
    <main role="main" style="margin-top: 130px">
      <div class="container">
        <!-- dashcon1 -->
        <iframe
          src="https://drive.google.com/drive/u/3/folders/1at4KgzUN23cq_oxqjtaB2xCsnWkvHHpW?preview"
          width="50%"
        ></iframe>
              ...
              <div class="fotter-coo">
                ...
                <div class="gallery-row row">
                  <div class="col-md-4 col-6 gall-col">
                    <img
                      src="http://localhost/trackt/assets/images/gallery/g1.jpg"
                      alt=""
                    />
                  </div>
                  <div class="col-md-4 col-6 gall-col">
                    <img
                      src="http://localhost/trackt/assets/images/gallery/g2.jpg"
                      alt=""
                    />
                  </div>
                  <div class="col-md-4 col-6 gall-col">
                    <img
                      src="http://localhost/trackt/assets/images/gallery/g3.jpg"
                      alt=""
                    />
                  </div>
                  <div class="col-md-4 col-6 gall-col">
                    <img
                      src="http://localhost/trackt/assets/images/gallery/g4.jpg"
                      alt=""
                    />
                  </div>
                  <div class="col-md-4 col-6 gall-col">
      ...
      <div class="copy">
        <div class="container">
          <a href="https://www.smarteyeapps.com/"
            >2020 � All Rights Reserved | Designed and Developed by STM</a
          >
